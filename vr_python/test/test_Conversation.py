...
workspace_id = '76245395-689c-406a-a712-52960cbf2500'
...
response = conversation.create_workspace(name='test_Conversation_1',
                                         description='sample.',
                                         language='ko',
                                         metadata=None)
print(json.dumps(response, indent=2))

workspace_id = response['76245395-689c-406a-a712-52960cbf2500']
