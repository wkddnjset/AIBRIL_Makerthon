...
public static void main(String[] args) throws IOException{
      ...
      try {
          ...
          Document forecast = Jsoup.connect("https://search.naver.com/search.naver?where=nexearch&sm=top_hty&fbm=0&ie=utf8&query="+word+"+날씨").get();
          Elements forecast_1 = forecast.select(".c_body .w_now2 .fl em");
          // .w_now2 .fl
         String title = forecast_1.text();
